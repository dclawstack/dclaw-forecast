...
**DClaw Forecast** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8046` (FastAPI)
- **Frontend Port:** `3046` (Next.js)
- **Database:** `dclaw_forecast` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3046`
